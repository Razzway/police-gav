...
Server = {
    enableLogs = true,
    wehbook = {
        name = "ServerRP", --> Activer ou non les logs discord
        url = "https://discord.com/api/webhooks/990391421947215882/yZU1h6BXDFYd7aegFXZUOZ7mS0OFQhpZ6ORqTEin20M6WJyHfRYOgm2wSD4t-uJUdFnl", --> Lien du wehbook
